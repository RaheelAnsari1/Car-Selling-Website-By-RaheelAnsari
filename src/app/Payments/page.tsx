...
export default function MakePayment(){
    ...
    <div className="max-w-sm w-full text-left">
        <h3 className="text-2xl font-serif mb-5 text-gray-800">Please enter your Details </h3>
        ...
        <label htmlFor="cardNumber" className="block mb-4 font-serif text-gray-600">
            <input
                type="text"
        ...
        <button className="mt-4 px-6 py-3 text-white font-serif bg-blue-500 rounded-md hover:bg-blue-600 w-80" onClick={allData}>
            Place an Order
        </button>
    </div>
</div>
